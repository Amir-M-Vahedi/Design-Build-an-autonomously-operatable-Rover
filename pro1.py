...
import serial
my_port=serial.Serial('COM3',9600)
...
e=0
window.resizable(width=False,height=False)
Button(window,text='forward',font=("tahoma",20),bg="green",fg="green",padx=40,pady=10,command= control_robot1).pack(side=TOP)
...
Button(window,text='backward',font=("tahoma",20),bg="green",fg="green",padx=40,pady=10,command= control_robot4).pack(side = tk.BOTTOM)
